	...
	return (
		...
		>
			<div className='space-y-4'>
				...
				<motion.button
					type='button'
					className='flex w-full items-center justify-center rounded-lg bg-orange-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-[#9a6605] focus:outline-none focus:ring-4 focus:ring-emerald-300'
